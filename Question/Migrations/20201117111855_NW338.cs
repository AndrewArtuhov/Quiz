...
{
    public partial class NW338 : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", nullable: true),
                    ThemeId = table.Column<long>(type: "INTEGER", nullable: true),
                    TimerId = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Timers_TimerId",
                        column: x => x.TimerId,
